...
JS.Test.describe("templates.concert() [-test-dark:0-]", function() { with(this) {
  ...
  it("renders the artist name [-test-dark:1-]", function() { with(this) {
    assertEqual( "Boredoms", html.find(".artist").text() )
  }})

  it("renders the venue details [-test-dark:2-]", function() { with(this) {
...
JS.Test.describe("ConcertView [-test-dark:3-]", function() { with(this) {
  extend(HtmlFixture)
  ...
  it("renders the artist name [-test-dark:4-]", function() { with(this) {
    assertEqual( "Boredoms", fixture.find(".artist").text() )
  }})

  it("updates the artist name if it changes [-test-dark:5-]", function() { with(this) {
