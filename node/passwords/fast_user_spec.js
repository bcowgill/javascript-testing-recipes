...
with (JS.Test) {
	describe("User (fast) [-fast_user_spec:0-]", function () { with (this) { addSkip(this)
		before(function () { with (this) {
			stub(User, "WORK_FACTOR", 1)
			this.user = new User()
		}})

		describe("with no password [-fast_user_spec:1-]", function () { with (this) { addSkip(this)
		...
		describe("with a password [-fast_user_spec:3-]", function () { with (this) { addSkip(this)
			before(function () { with (this) {
