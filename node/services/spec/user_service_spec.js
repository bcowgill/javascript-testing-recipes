...
with (JS.Test) {
	describe("UserService [-user_service_spec:0-]", function () { with (this) { addSkip(this)
		...
		describe("with an existing user [-user_service_spec:2-]", function () { with (this) { addSkip(this)
