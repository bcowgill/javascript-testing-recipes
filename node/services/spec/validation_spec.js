...
JS.Test.describe("validation [-validation_spec:0-]", function() { with(this) {
  describe("checkUser() [-validation_spec:1-]", function() { with(this) {
  ...
  describe("checkMessage() [-validation_spec:5-]", function() { with(this) {
  ...
  describe("checkPoll() [-validation_spec:8-]", function() { with(this) {
